...
def get_dataset(args):
    with open(args.file, 'r', encoding="utf-8") as f:
        ...
        for i in range(len(data)):
            question1 = data[i]["input"]
            question2 = data[i]["question"]

            ans = get_res_batch(question1, question2)
            
            if ans == "Yes" or ans == "yes":
                judgement = "Yes"
            else:
                judgement = "No"
            gen = {"id":data[i]["id"],"input": question1, "question": question2, "judgement": judgement}
